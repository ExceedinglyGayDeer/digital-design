// ======================================================================
// Control_register.v generated from TopDesign.cysch
// 03/22/2019 at 13:46
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_80 or Net_5 or Net_6 or Net_8 or Net_83)
        begin
            case (Net_83[1:0])
                2'b00 :  tmp__mux_1_reg = Net_80;
                2'b01 :  tmp__mux_1_reg = Net_5;
                2'b10 :  tmp__mux_1_reg = Net_6;
                2'b11 :  tmp__mux_1_reg = Net_8;
            endcase
        end
        assign Net_2 = tmp__mux_1_reg;
    end
    // -- Mux end --
	...
	cy_clock_v1_0
		#(.id("f6c44cf9-8ca2-4f97-9d65-971dc3fff5bb"),
		  .source_clock_id(""),
		  .divisor(0),
