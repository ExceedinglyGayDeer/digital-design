...
void CapSense_CSD_PreScan(uint8 sensor) CYREENTRANT
{
    ...
    #ifdef CapSense_CSD_PRE_SCAN_DISABLE_INT_CALLBACK
    CapSense_CSD_PreScan_DisableInt_Callback();
    #endif /* CapSense_CSD_PRE_SCAN_DISABLE_INT_CALLBACK */
    ...
    #ifdef CapSense_CSD_PRE_SCAN_ENABLE_INT_CALLBACK
        CapSense_CSD_PreScan_EnableInt_Callback();
    #endif /* CapSense_CSD_PRE_SCAN_ENABLE_INT_CALLBACK */
}
