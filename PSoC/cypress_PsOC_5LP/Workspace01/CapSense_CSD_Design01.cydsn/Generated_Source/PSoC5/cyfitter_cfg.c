...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x480003A8u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x480003B0u)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480003B8u)
...
uint8 CYXDATA * const CYCODE CapSense_CSD_AMuxCH0__addrTable[8] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE CapSense_CSD_AMuxCH0__maskTable[8] = {
	0x01u, 
	0x02u, 
	0x04u, 
	0x08u, 
