// ======================================================================
// PSoC_ISR.v generated from TopDesign.cysch
// 03/27/2019 at 09:24
...
module top ;
	...
	wire [0:0] tmpOE__Pin_Yellow_net;
	wire [0:0] tmpFB_0__Pin_Yellow_net;
	wire [0:0] tmpIO_0__Pin_Yellow_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Yellow_net;
	electrical [0:0] tmpSIOVREF__Pin_Yellow_net;

	cy_psoc3_pins_v1_10
		#(.id("1d589673-6329-484c-93e6-0bc7e709a68d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Yellow
		 (.oe(tmpOE__Pin_Yellow_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Yellow_net[0:0]}),
		  .io({tmpIO_0__Pin_Yellow_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Yellow_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Yellow_net[0:0]}),
		  .annotation({Net_15}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Yellow_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
